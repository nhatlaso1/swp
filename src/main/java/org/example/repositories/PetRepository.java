...
public interface PetRepository extends JpaRepository<Pet, Integer> {
    ...
    @Query(value = "CALL pet_find_with_filter(:type, :address,  :pet_type_id, :age_from, :age_to, :status, :page_size, :page_number)", nativeQuery = true)
    ...
    @Query(value = "CALL pet_count_with_filter(:type, :address, :pet_type_id, :status, :age_from, :age_to)", nativeQuery = true)
